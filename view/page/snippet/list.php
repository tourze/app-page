<div class="row-fluid">
    <div class="span9">
        <table
            ...
            data-delete-callback="<?php echo Route::url('page-admin', ['controller' => 'Snippet', 'action' => 'delete']) ?>"
            data-delete-title="<?php echo __('Are you sure to delete this snippet?') ?>"
            data-newitem-callback="<?php echo Route::url('page-admin', ['controller' => 'Snippet', 'action' => 'newitem']) ?>"
            >
                ...
                <tr id="admin-page-snippet-item-<?php echo $snippet->id ?>">
                    ...
                    <td class="name">
                        <a
                            ...
                            class="editable"
                            data-type="text"
                            data-url="<?php echo Route::url('page-admin', ['controller' => 'Snippet', 'action' => 'update']) ?>"
                    ...
                    <td class="actions">
                        ...
                        <button class="btn btn-mini btn-danger delete"
                                data-id="<?php echo $snippet->id ?>"><?php echo __('Delete') ?></button>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
