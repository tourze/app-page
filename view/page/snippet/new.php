            ...
            <div class="control-group">
                <div class="controls">
                    <label for="markdown" class="checkbox inline">
                        <input type="checkbox" name="markdown" id="markdown" class="check"<?php if ($snippet->markdown)
                        {
                            echo ' checked';
                        } ?> />
                    ...
                    <label for="twig" class="checkbox inline">
                        <input type="checkbox" name="twig" id="twig" class="check"<?php if ($snippet->twig)
                        {
                            echo ' checked';
                        } ?> />
