<div class="row-fluid">
    <div class="span9">
        ...
        <table
            ...
            data-delete-callback="<?php echo Route::url('page-admin', ['controller' => 'Layout', 'action' => 'delete']) ?>"
            data-delete-title="<?php echo __('Are you sure to delete this layout?') ?>"
            data-newitem-callback="<?php echo Route::url('page-admin', ['controller' => 'Layout', 'action' => 'newitem']) ?>"
            >
                ...
                <tr id="admin-page-layout-item-<?php echo $layout->id ?>">
                    ...
                    <td class="name">
                        <a
                            ...
                            class="editable"
                            data-type="text"
                            data-url="<?php echo Route::url('page-admin', ['controller' => 'Layout', 'action' => 'update']) ?>"
                    ...
                    <td class="actions">
                        ...
                        <button class="btn btn-mini btn-danger delete"
                                data-id="<?php echo $layout->id ?>"><?php echo __('Delete') ?></button>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
