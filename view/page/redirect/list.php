<div class="row-fluid">
    <div class="span9">
        ...
        <table
            ...
            data-delete-callback="<?php echo Route::url('page-admin', ['controller' => 'Redirect', 'action' => 'delete']) ?>"
            data-delete-title="<?php echo __('Are you sure to delete this redirect?') ?>"
            data-newitem-callback="<?php echo Route::url('page-admin', ['controller' => 'Redirect', 'action' => 'newitem']) ?>"
            >
                ...
                <tr id="admin-page-layout-item-<?php echo $redirect->id ?>">
                    ...
                    <td class="url">
                        <a
                            ...
                            class="editable"
                            data-type="text"
                            data-url="<?php echo Route::url('page-admin', ['controller' => 'Redirect', 'action' => 'update']) ?>"
                    ...
                    <td class="actions">
                        <a class="btn btn-mini btn-info" href="<?php echo Route::url('page-admin', [
                            'controller' => 'Redirect',
                            'action'     => 'edit',
                            'params'     => $redirect->id,
                        ]) ?>"><?php echo __('Edit') ?></a>
                        <button class="btn btn-mini btn-danger delete"
                                data-id="<?php echo $redirect->id ?>"><?php echo __('Delete') ?></button>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
