...
<div class="row-fluid">
	<div class="span9">
		<form class="form-horizontal" method="post">
			...
			<div class="control-group">
				<label class="control-label" for="generate_html"><?php echo __('Generate Static HTML') ?></label>
				<div class="controls">
					<label for="generate_html" class="checkbox">
						<input type="checkbox" class="check" id="generate_html" name="generate_html"<?php if ($page->generate_html) { echo ' checked'; } ?> />
						<?php echo __('Generate the static html cache in the server.') ?>
					</label>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea style="height:60px;" id="metakw" class="span12" name="metakw"><?php echo $page->metakw ?></textarea>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea style="height:60px;" id="metadesc" class="span12" name="metadesc"><?php echo $page->metadesc ?></textarea>
