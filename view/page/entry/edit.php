			...
			<div class="control-group">
				...
				<div class="controls">
					<label for="is_link" class="checkbox">
						<input type="checkbox" class="check" id="is_link" name="is_link"<?php if ($page->is_link) { echo ' checked'; } ?> />
			...
			<div class="control-group">
				...
				<div class="controls">
					<label for="show_nav" class="checkbox">
						<input type="checkbox" class="check" id="show_nav" name="show_nav"<?php if ($page->show_nav) { echo ' checked'; } ?> />
			...
			<div class="control-group">
				...
				<div class="controls">
					<label for="show_map" class="checkbox">
						<input type="checkbox" class="check" id="show_map" name="show_map"<?php if ($page->show_map) { echo ' checked'; } ?> />
