<div class="row-fluid">
    <div class="span9">
        <form class="form-horizontal" method="post">
            ...
            <p class="alert alert-info"><?php echo __('Adding a sub page to ":page".', [':page' => $parent->name]) ?></p>
                ...
                <div class="controls">
                    <select id="location" name="location">
                        ...
                        <?php foreach ($parent->children() AS $child): ?>
                            <option
                                value="<?php echo $child->id ?>"><?php echo __('After :child', [':child' => $child->name]) ?></option>
                        <?php endforeach; ?>
                        <option value="last" selected="selected"><?php echo __('Last Child') ?></option>
                    </select>
					<span
                        class="help-block"><?php echo __('Where in the list of siblings this page will appear.') ?></span>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="url" id="url" class="span12" value="<?php echo $page->url ?>"/>
					<span
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <label for="is_link" class="checkbox">
                        <input type="checkbox" id="is_link" name="is_link"<?php if ($page->is_link)
                        {
                            echo ' checked';
                        } ?> />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <label for="show_nav" class="checkbox">
                        <input type="checkbox" id="show_nav" name="show_nav"<?php if ($page->show_nav)
                        {
                            echo ' checked';
                        } ?> />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <label for="show_map" class="checkbox">
                        <input type="checkbox" id="show_map" name="show_map"<?php if ($page->show_map)
                        {
                            echo ' checked';
                        } ?> />
