...
<div id="editor-toolbar" class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
	...
	<div id="editor-group-image" class="btn-group">
		...
		<div class="dropdown-menu input-append">
			...
			<a class="btn" id="pictureBtn" title="<?php echo __('Select an image on local') ?>"><?php echo __('Upload') ?></a>
			<input id="pictureBtnCallback" type="file" data-role="magic-overlay" data-target="#pictureBtn" data-edit="uploadImage" data-callback="" />
		</div>
	</div>
	<div class="btn-group">
...
<input id="wysiwyg-content" class="content" name="content" type="text" style="display:none;" />
