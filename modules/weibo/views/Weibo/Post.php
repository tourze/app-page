...
// uploadify
Page::style('uploadify/uploadify.css');
Page::script('uploadify/jquery.uploadify.min.js');
Page::style('weibo/css/style.css');
Page::script('weibo/js/script.js');
?>
<div id="weibo-post" class="row-fluid">
	<div class="offset3 span6">
		...
		<form method="post">
			...
			<p>当前用户：
				<a href="<?php echo $re_auth_url ?>" title="<?php echo __('Re-Authentication') ?>">
					<strong><?php echo Session::instance()->get('screen_name') ?></strong>
				</a>
				<span id="weibo-post-words">字数：<small>0</small></span>
			</p>
