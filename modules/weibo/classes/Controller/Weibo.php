 ...
 * @author		YwiSax
 */
class Controller_Weibo extends Controller_Page {
	...
	public function action_post()
	{
		...
		$this->render(array(
			'title' => __('Post Weibo'),
			'metadesc' => Kohana::$config->load('weibo.metadesc'),
			'metakw' => Kohana::$config->load('weibo.metakw'),
			'content' => View::factory('weibo/post', array(
				're_auth_url' => $code_url,
			)),
		));
	}
