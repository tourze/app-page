...
<div class="row-fluid">
	<div class="span9">
		<form class="form-horizontal" method="post">
			<legend><?php echo __('Create a New Layout') ?></legend>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="name" type="text" id="name" class="span12" value="<?php echo $layout->name ?>" />
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="title" type="text" id="title" class="span12" value="<?php echo $layout->title ?>" />
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="desc" type="text" id="desc" class="span12" value="<?php echo $layout->desc ?>" />
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="code" id="code" class="span12"><?php echo $layout->code ?></textarea>
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn" href="<?php echo Route::url('page-admin', array('controller' => 'Layout')) ?>"><?php echo __('Cancel') ?></a>
				</div>
			</div>
		</form>
	</div>
