 ...
 * @copyright	YwiSax
 */
class Controller_Page_Snippet extends Controller_Page_Admin {
	...
	{		
		...
		$this->template->content = View::factory('page/snippet/list', array(
	...
	public function action_new()
	{
		...
		$this->template->content = View::factory('page/snippet/new', array(
			'snippet' => $snippet,
			'errors' => FALSE,
		));
		...
		if ($this->request->post())
		{
			...
			{
				$snippet->save();
				HTTP::redirect(Route::url('page-admin', array('controller' => 'Snippet')));
			}
	...
	public function action_edit()
	{
		...
		$this->template->content = View::factory('page/snippet/edit', array(
			'snippet' => $snippet,
			'errors' => FALSE,
			'success' => FALSE,
		));
		...
		if ( ! $snippet->loaded())
		{
			throw new Page_Exception('Could not find snippet with id ":id".', array(
				':id' => $id,
			));
		}
	...
	public function action_delete()
	{
		...
		$this->template->content = View::factory('page/snippet/delete', array('snippet' => $snippet));
