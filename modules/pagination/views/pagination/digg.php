...
<?php
	...
	{
		echo '<li>'.HTML::anchor($page->url($previous_page), __('&laquo;'), array('class' => 'previous', 'data-page' => $previous_page)).'</li>';
	}
	...
	if ($next_page !== FALSE)
	{
		echo '<li>'.HTML::anchor($page->url($next_page), __('&raquo;'), array('class' => 'next', 'data-page' => $next_page)).'</li>';
	}
?>
</ul>
</div>
