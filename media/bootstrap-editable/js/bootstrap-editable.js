...
//                var h = this.$input.outerHeight(true) || 20,
    ...
    Text.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        /**
        @property tpl 
        @default <input type="text" class="m-wrap">
        **/         
        tpl: '<input type="text" class="m-wrap">',
        /**
...
(function ($) {
    ...
    Range.defaults = $.extend({}, $.fn.editabletypes.number.defaults, {
        ...
        inputclass: 'input-medium m-wrap'
    });
...
(function ($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
         ...
         initInput: function() {  
            ...
            //for bs2 set default class `input-medium m-wrap` to standard inputs
            var emptyInputClass = this.input.options.inputclass === null || this.input.options.inputclass === false;
            var defaultClass = 'input-medium m-wrap';
...
Shows normal <input type="text" class="m-wrap"> and binds popup datepicker.  
...
Shows normal <input type="text" class="m-wrap"> and binds popup datetimepicker.  
Automatically shown in inline mode.
